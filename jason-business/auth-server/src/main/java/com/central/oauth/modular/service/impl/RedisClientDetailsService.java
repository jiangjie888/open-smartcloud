...
public class RedisClientDetailsService extends JdbcClientDetailsService {
    ...
    public ClientDetails loadClientByClientId(String clientId) {
        ...
        // 先从redis获取
        String value = (String) redisTemplate.boundHashOps(SecurityConstants.CACHE_CLIENT_KEY).get(clientId);
    ...
    private ClientDetails cacheAndGetClient(String clientId) {
        ...
        try {
            ...
            if (clientDetails != null) {
                ...
                redisTemplate.boundHashOps(SecurityConstants.CACHE_CLIENT_KEY).put(clientId, JSONObject.toJSONString(clientDetails));
    ...
    private void removeRedisCache(String clientId) {
        ...
        redisTemplate.boundHashOps(SecurityConstants.CACHE_CLIENT_KEY).delete(clientId);
    }
    ...
    public void loadAllClientToCache() {
        if (redisTemplate.hasKey(SecurityConstants.CACHE_CLIENT_KEY)) {
            return;
        }
        ...
        list.parallelStream().forEach(client -> {
            redisTemplate.boundHashOps(SecurityConstants.CACHE_CLIENT_KEY).put(client.getClientId(), JSONObject.toJSONString(client));
        });
