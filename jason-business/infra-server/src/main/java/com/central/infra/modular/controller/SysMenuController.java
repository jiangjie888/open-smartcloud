...
import com.central.infra.modular.service.ISysMenuService;
...
public class SysMenuController {
    ...
    @GetMapping("/findMenuByRoles/{roleCodes}")
    ...
    @PostMapping("/granted")
    public ResponseData setMenuToRole(@RequestBody SysMenu sysMenu) {
    ...
    public ResponseData saveOrUpdate(@RequestBody SysMenu menu) {
        try {
    ...
    public List<SysMenu> findMyMenu(@LoginUser SysUser user) {
        ...
        List<SysMenu> menus = menuService.findByRoleCodes(roles.parallelStream().map(SysRole::getRoleCode).collect(Collectors.toSet()), CommonConstant.MENU);
