...
import com.central.core.utils.RenderUtil;
	...
	public AuthenticationFailureHandler loginFailureHandler() {
		return new AuthenticationFailureHandler() {
			...
			public void onAuthenticationFailure(HttpServletRequest request, HttpServletResponse response,
				...
				ResponseData result = new ErrorResponseData(HttpStatus.UNAUTHORIZED.value(), msg);
	...
	public AuthenticationEntryPoint authenticationEntryPoint() {
		return new AuthenticationEntryPoint() {
			...
			public void commence(HttpServletRequest request, HttpServletResponse response,
				...
				ResponseData result = new ErrorResponseData(HttpStatus.UNAUTHORIZED.value(), authException.getMessage());
				response.setStatus(HttpStatus.UNAUTHORIZED.value());
				RenderUtil.renderJson(response,result);
				response.getWriter().flush();
				response.getWriter().close();
