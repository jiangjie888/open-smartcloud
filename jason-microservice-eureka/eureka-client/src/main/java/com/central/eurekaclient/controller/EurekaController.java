...
public class EurekaController {
    ...
    public String status() {
        String url = "http://127.0.0.1:9000/eureka/status";
        return getinfo(url);
    }
    ...
    public String apps() {
        String url = "http://127.0.0.1:9000/eureka/apps";
        return getinfo(url);
    }
    ...
    public String appsmd(@RequestParam(value = "name", required = false) String str) {
        String url = "http://127.0.0.1:9000/eureka/apps/" + str;
        return getinfo(url);
    }
    ...
    public String appsmddel(@RequestParam(value = "name", required = false) String str) {
        String url = "http://127.0.0.1:9000/metadata/apps/" + str;
